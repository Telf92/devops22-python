...
print(f'[1] tuple_paranthesis is of type {type(tuple_paranthesis)} with value: {tuple_paranthesis}')

# You can create a tuple with comma ,
tuple_comma = 5, 3, 4
print(f'[2] tuple_comma is of type {type(tuple_comma)} with value: {tuple_comma}')

# You can create a tuple with the built-in tuple(iterable)
tuple_builtin = tuple([1, 2, 3])
print(f'[3] tuple_builtin is of type {type(tuple_builtin)} with value: {tuple_builtin}')

# To access the first element use index 0.
example_tuple = (10, 20, 30)
print(f'[4] index 0 is {example_tuple[0]}')

# To access the last tuple slot use index lne() - 1
example_tuple = (10, 20, 30)
