...
# Random shuffle
names = ["Adam", "Bertil", "Caesar", "David", "Erik", "Filip", "Gustav", "Helge", "Ivar", "Johan"]

# Shuffle will change the order in place
shuffle(names)
print(names)

# If you want a new list use sample, this wil make 10 of each
...
abs = list(string.ascii_uppercase)